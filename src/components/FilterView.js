...
const FilterView = () => {
  ...
  return (
    <div>
      <Modal data-cy="FilterView" id="filterView" active={filterViewOpen}>
        <React.Fragment>
          <Modal.Background
            style={{
              height: "100%",
              ...
              >
                ...
                <div style={{ width: "100%" }}>
                  ...
                  <Button.Group hasAddons>
                    <Button
                      rounded
                      color={maybeFilter.filterParking ? "info" : "white"}
                      style={{ width: "25%" }}
                      onClick={() => {
                        setMaybeFilter({
                          ...maybeFilter,
                          filterParking: !maybeFilter.filterParking
                        });
                      }}
                    >
                    ...
                    <Button
                      rounded
                      color={maybeFilter.filterRamp ? "info" : "white"}
                      style={{ width: "25%" }}
                      onClick={() => {
                        setMaybeFilter({
                          ...maybeFilter,
                          filterRamp: !maybeFilter.filterRamp
                        });
                      }}
                    >
                    ...
                    <Button
                      rounded
                      color={maybeFilter.filterElevator ? "info" : "white"}
                      style={{ width: "25%" }}
                      onClick={() => {
                        setMaybeFilter({
                          ...maybeFilter,
                          filterElevator: !maybeFilter.filterElevator
                        });
                      }}
                    >
                    ...
                    <Button
                      rounded
                      color={maybeFilter.filterLock ? "info" : "white"}
                      style={{ width: "25%" }}
                      onClick={() => {
                        setMaybeFilter({
                          ...maybeFilter,
                          filerLock: !maybeFilter.filterLock
                        });
                      }}
                    >
